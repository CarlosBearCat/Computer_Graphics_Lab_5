...
function Cone() {
    ...
    for (var i = 0; i < discTriangles; i++){
        ...
        this.normals[i*6+2] = vec4(0,-1,0,0);
            ...
            //cone part of the cone
        this.normals[i*6+3] = vec4(Math.cos(angle1+angle2 / 2),Math.sin(angle1+angle2 / 2),1,0);// angle1+angle2 because of the top of the cone
        this.normals[i*6+4] = vec4(Math.cos(angle2),Math.sin(angle2),1,0);
        this.normals[i*6+5] = vec4(Math.cos(angle1),Math.sin(angle1),1,0);
    }
}